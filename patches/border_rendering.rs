...
pub(crate) fn merge_border(a: &BorderLine, b: &BorderLine) -> BorderLine {
    ...
    let priority = |lt: BorderLineType| -> u8 {
        match lt {
            ...
            | BorderLineType::Circle => 1,
            BorderLineType::Solid
            | BorderLineType::Thick3D
            | BorderLineType::Thick3DReverse
            | BorderLineType::Thin3D
            | BorderLineType::Thin3DReverse => 2,
            BorderLineType::Wave | BorderLineType::DoubleWave => 3,
            BorderLineType::Double
            | BorderLineType::ThinThickDouble
            | BorderLineType::ThickThinDouble => 4,
            BorderLineType::ThinThickThinTriple => 5,
        }
    };
